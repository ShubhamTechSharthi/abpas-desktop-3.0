  ...
  export default function FAR() {
    const farData = [
      ...
      },
      {
        ...
        minRequired: 225.00,
        maxPermissible: "N.A.",
        requiredValues: 107.20,
        provided: 111.69,
        result: "Compliant"
      },
      // Add other plot data objects here...
    ];
    ...
    return (
      <table className="w-full text-center mt-3">
        <thead>
          <tr>
            <th colSpan={7} className="border bg-gray-400 text-gray-800 border-slate-300 p-2">FAR</th>
          </tr>
          <tr>
            <th className="border text-gray-700 border-slate-300 p-2">Plot Number</th>
            <th className="border text-gray-700 border-slate-300 p-2">Rules from BVN / Master Plan</th>
        ...
        <tbody>
          {farData.map((data, index) => (
            <tr key={index}>
              <td className="font-normal border border-slate-300 p-1">{data.plotNumber}</td>
              <td className="font-normal border border-slate-300 p-1">{data.rules}</td>
              <td className="font-normal border border-slate-300 p-1">{data.minRequired}</td>
              <td className="font-normal border border-slate-300 p-1">{data.maxPermissible}</td>
              <td className="font-normal border border-slate-300 p-1">{data.requiredValues}</td>
              <td className="font-normal border border-slate-300 p-1">{data.provided}</td>
              <td className="font-normal border border-slate-300 p-1">{data.result}</td>
            </tr>
          ))}
        </tbody>
      </table>
