...
export default function BuildingHeights() {
  const buildingHeightData = [
    { plotNumber: '1', rules: 'Master Plan', minRequired: 'N.A.', maxPermissible: 'N.A.', requiredValues: '12.00', provided: '9', result: 'Compliant' },
  ...
  return (
    <table className="w-full text-center mt-3">
      <thead>
        <tr>
          <th colSpan="7" className="border bg-gray-300 text-gray-800 border-slate-300 p-2">
            Building Height
          </th>
        </tr>
        <tr>
      ...
      <tbody>
        {buildingHeightData.map((item, index) => (
          <tr key={index}>
            <td className="border border-slate-300 p-1">{item.plotNumber}</td>
            <td className="border border-slate-300 p-1">{item.rules}</td>
            <td className="border border-slate-300 p-1">{item.minRequired}</td>
            <td className="border border-slate-300 p-1">{item.maxPermissible}</td>
            <td className="border border-slate-300 p-1">{item.requiredValues}</td>
