// export default function RoadWidth() {
//     return (
  ...
  export default function RoadWidth() {
    ...
    return (
      <table className="w-full text-center mt-3">
        ...
        <tbody>
          {roadWidthData.map((row, index) => (
            <tr key={index}>
              <td className="font-normal border border-slate-300 p-1">{row.plotNumber}</td>
              <td className="font-normal border border-slate-300 p-1">{row.rule}</td>
              ...
              <td className="font-normal border border-slate-300 p-1">{row.colonyRuleValue}</td>
